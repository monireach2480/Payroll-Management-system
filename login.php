...
<body>
  ...
  ?>
  <div class="container">
    <form class="form_container" action="model/Login/actionLogin.php" method="post">
      <div class="logo_container">
        <img src="upload/clubcode.jpg" alt="" style="width: 100%;height: 100%;">
      </div>
      ...
      <div class="input_container">
        ...
        <input placeholder="...." title="Inpit title" name="username" type="text" class="input_field" id="email_field">
      </div>
      <div class="input_container">
